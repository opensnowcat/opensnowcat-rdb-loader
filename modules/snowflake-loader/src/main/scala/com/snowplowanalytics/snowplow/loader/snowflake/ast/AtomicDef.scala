...
import com.snowplowanalytics.snowplow.loader.snowflake.ast.SnowflakeDatatype._
...
object AtomicDef {
  ...
  def getTable(schema: String = "atomic"): CreateTable =
    CreateTable(schema, EventsTable.MainName, columns, Some(PrimaryKeyConstraint("event_id_pk", "event_id")))
